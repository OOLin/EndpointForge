// src/lib.rs
/*
 * Core library for EndpointForge
 */
...
#[derive(Debug)]
pub struct EndpointForgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EndpointForgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EndpointForge processing");
    
    let mut processor = EndpointForgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EndpointForgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EndpointForgeProcessor::new(false);
